...
<head>
    <base href="">
    <meta charset="utf-8" />
    <title>Create Offer| <?php echo WEBSITE_TITLE; ?></title>
    ...
    <link href="/assets/css/wizard/wizard-1.css" rel="stylesheet" />
</head>
<!--end::Head-->
<!--begin::Body-->
						...
						<div class="subheader py-2 py-lg-4 subheader-transparent" id="kt_subheader">
							<div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-2">
									<!--begin::Title-->
									<h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Create New Offer</h5>
									<!--end::Title-->
									<!--begin::Separator-->
									...
									<div class="d-flex align-items-center" id="kt_subheader_search">
										<span class="text-dark-50 font-weight-bold" id="kt_subheader_total">Enter offer details and submit</span>
									</div>
									<!--end::Search Form-->
								</div>
								<!--end::Details-->
												...
												<div class="wizard-steps p-8 p-lg-10">
													...
													<div class="wizard-step" data-wizard-type="step" data-wizard-state="current">
														<div class="wizard-label">
															...
															<h3 class="wizard-title">Offer Details</h3>
														</div>
													...
													<div class="wizard-step" data-wizard-type="step">
														<div class="wizard-label">
															...
															<h3 class="wizard-title">Add Payout / Revenue</h3>
														</div>
														<span class="svg-icon svg-icon-xl wizard-arrow">
															<!--begin::Svg Icon | path:assets/media/svg/icons/Navigation/Arrow-right.svg-->
															<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
													...
													<div class="wizard-step" data-wizard-type="step">
														<div class="wizard-label">
															...
															<h3 class="wizard-title">Select Affiliates</h3>
														</div>
														<span class="svg-icon svg-icon-xl wizard-arrow">
															<!--begin::Svg Icon | path:assets/media/svg/icons/Navigation/Arrow-right.svg-->
															<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
													...
													<div class="wizard-step" data-wizard-type="step">
														<div class="wizard-label">
															...
															<h3 class="wizard-title">Add Geo Targeting</h3>
														</div>
														<span class="svg-icon svg-icon-xl wizard-arrow">
															<!--begin::Svg Icon | path:assets/media/svg/icons/Navigation/Arrow-right.svg-->
															<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
													...
													<div class="wizard-step" data-wizard-type="step">
														<div class="wizard-label">
															...
															<h3 class="wizard-title">Tracking Settings</h3>
														</div>
														<span class="svg-icon svg-icon-xl wizard-arrow">
															<!--begin::Svg Icon | path:assets/media/svg/icons/Navigation/Arrow-right.svg-->
															<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
																...
																<div class="col-xl-12">
																	<div class="form-group row">
																		...
																		<div class="col-lg-9 col-xl-9">
																			<input class="form-control form-control-lg form-control-solid" name="projectname" type="text" placeholder="Project Name" value="" />
																		</div>
																	</div>
																	<div class="form-group row">
																		<label class="col-xl-3 col-lg-3 col-form-label">Project Owner</label>
																		<div class="col-lg-9 col-xl-9">
																			<input class="form-control form-control-lg form-control-solid" name="projectowner" type="text" placeholder="Project Owner" value="" />
																		</div>
																	</div>
																	<div class="form-group row">
																		<label class="col-xl-3 col-lg-3 col-form-label">Customer Name</label>
																		<div class="col-lg-9 col-xl-9">
																			<input class="form-control form-control-lg form-control-solid" name="customername" type="text" placeholder="Customer Name" value="" />
...
<script src="../assets/js/wizard/wizard-1.js"></script>
