...
<div id="kt_quick_actions" class="offcanvas offcanvas-left p-10 d-none">
	<!--begin::Header-->
	...
	<div class="offcanvas-content pr-5 mr-n5">
		...
		<div class="d-flex align-items-center mt-5">
			<div class="symbol symbol-100 mr-5">
				<div class="symbol-label" style="background-image:url('https://icwwebsite.s3.ap-south-1.amazonaws.com/images/favi.gif')"></div>
				<i class="symbol-badge bg-success"></i>
			</div>
			<div class="d-flex flex-column">
				<a href="javascript:void(0)" class="font-weight-bold font-size-h5 text-dark-75 text-hover-primary userFullName">&nbsp;</a>
...
<!-- end::User Panel-->
<!--begin::Quick Panel-->
<div id="kt_quick_panel" class="offcanvas offcanvas-left pt-5 pb-10 d-none">
	<!--begin::Header-->
