...
<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
            ...
            <form action="" method="POST" id="add-user-mapping-form" onsubmit="addUserMapping()">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Add More Mapping</h5>
    ...
    <!-- Add New Company Modal Starts -->
    <div class="modal fade" id="company-create-modal" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <form method="POST" id="company-create-form">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="companyGstn" class="form-control" placeholder="Company GSTN">
                                </div>
                            </div>
                            ...
                            <div class="col-sm-12 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="companyCin" class="form-control" placeholder="Company CIN">
                                </div>
                            ...
                            <div class="col-sm-12 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="companyPan" class="form-control" placeholder="Company PAN">
                                </div>
                            </div>
                            ...
                            <div class="col-sm-12 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="hidden" name="companyCountryCode" value="+91">
                                    <input type="text" name="companyMobile" class="form-control" placeholder="Company Mobile">
                                </div>
                            </div>
                            ...
                            <div class="col-sm-12 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="companyWebSite" class="form-control" placeholder="Company Website">
                                </div>
                            </div>
                    ...
                    <div class="modal-footer">
                        <button type="submit" class="btn btn-primary font-weight-bold" id="create-company-btn">Save Company</button>
                    </div>
                </div>
            </form>
        </div>
    </div>
    <!-- Add New Company Modal Ends -->
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane show active px-7" id="kt_profile" role="tabpanel">
                                            <form name="profile-form" id="profile-form">
                                                <input type="hidden" class="userType" name="userType" value="" id="userType">
                                                <input type="hidden" class="userCountryCode" name="userCountryCode" value="91">
                                                <input type="hidden" class="userRole" name="userRole" value="" id="userRole">
                                                <input type="hidden" class="isUserVerfied" name="isUserVerfied" value="" id="isUserVerfied">
                                                <input type="hidden" class="userStatus" name="userStatus" value="" id="userStatus">
                                                <!--begin::Row-->
                                                <div class="row">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-xl-7 my-2">
                                                        ...
                                                        <div class="form-group row">
                                                            <label class="col-form-label col-3 text-lg-right text-left">Company
                                                                Name</label>
                                                            <input type="hidden" name="companyId" class="companyId id" id="companyId">
                                                        ...
                                                        <div class="form-group row">
                                                            <label class="col-form-label col-3 text-lg-right text-left">GST
                                                                Number</label>
                                                            <div class="col-9">
                                                                <input class="form-control form-control-lg form-control-solid companyGstn" name="companyGstn" type="text" value="" placeholder="Company GST Number" id="companyGstn" />
                                                            </div>
                                                        </div>
                                                        <!--end::Group-->
                                                        <!--begin::Group-->
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-9">
                                                                <div class="input-group input-group-lg input-group-solid">
                                                                    <input type="text" class="form-control form-control-lg form-control-solid companyCin" name="companyCin" value="" id="companyCin" placeholder="Company CIN" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <!--end::Group-->
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-9">
                                                                <div class="input-group input-group-lg input-group-solid">
                                                                    <input type="text" class="form-control form-control-lg form-control-solid companyMobile" name="companyMobile" placeholder="Company Mobile" value="" id="companyMobile" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <!--end::Group-->
                                                        ...
                                                        <div class="col-xl-7">
                                                            ...
                                                            <div class="form-group row">
                                                                <label class="col-form-label col-3 text-lg-right text-left">New
                                                                    Password</label>
                                                                <div class="col-9">
                                                                    <input class="form-control form-control-lg form-control-solid" type="text" value="" placeholder="New password" />
                                                                </div>
                                                            </div>
                                                            <!--end::Group-->
                                                            <!--begin::Group-->
                                                            <div class="form-group row">
                                                                <label class="col-form-label col-3 text-lg-right text-left">Verify
                                                                    Password</label>
                                                                <div class="col-9">
                                                                    <input class="form-control form-control-lg form-control-solid" type="text" value="" placeholder="Verify password" />
                                                                </div>
                                                            </div>
                                                            <!--end::Group-->
                                                        </div>
                                                        ...
                                                        <div class="col-xl-7">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-sm-12 mb-5">
                                                                    <select class="form-control form-control-lg form-control-solid userRoles" name="currentRoles" multiple="multiple" id="current-permissions-role" style="width: 100%; background-color: #F3F6F9; color: #3F4254;"></select>
                                                                </div>
                                                            </div>
                                                            <div class="row mt-4">
                                                                <div class="col-sm-12" id="user-permissions">
...
<script>
    ...
    /* Add Listner when select2js dialog is opened */
    companaySelect.on('select2:open', () => {
        $(".select2-results:not(:has(a))").append('<span class="select2-results__option select2-results__message mb-2" data-toggle="modal" data-target="#company-create-modal"><a href="javascript:void(0)">Add New Company</a></span>');
    });
        ...
        $('#profile-btn-submit').on('click', function(e) {
            ...
            validation.validate().then(function(status) {
                ...
                if (status == 'Valid') {
                    ...
                    postForm(KBASE_URL + `partner/<?php echo $username; ?>/edit/basicInfo`, form, false, false, function(mData, mStatus) {
    ...
    var _addNewCompany = function() {
        let validation = FormValidation.formValidation(
            KTUtil.getById('company-create-form'), {
                fields: {
                    companyName: {
                        validators: {
                            notEmpty: {
                    ...
                    companyGstn: {
                        validators: {
                            notEmpty: {
                                message: 'Company GSTN is Required'
                            },
                        },
                    },
                    companyCin: {
        ...
        /////////////////////////////////////
        /////////////////////////////////////
        $('#create-company-btn').on('click', function(e) {
            e.preventDefault();
            console.log("Submitting....")
            validation.validate().then(function(status) {
                console.log('creating company status: ' + status);

                if (status == 'Valid') {
                    // Send data to server
                    let form = $('#company-create-form');
                    let username = getItem('userData', 'userName')
                    let companyId = $("#companyId").val();
                    postForm(KBASE_URL + `company/${username}/add`, form, false, false, function(mData, mStatus) {
                        if (mData.status === KSTATUS_SUCCESS) {
                            // update localstorage data with updated one
                            showToast(KSTATUS_SUCCESS, mData.msg);
                        } else {
    ...
    function fetchUserInfo() {
        let url = KBASE_URL + `partner/<?php echo $username; ?>/view`;
        let data = {
            url: url,
            params: ''
        };
    ...
    function __init() {
        ...
        fetchUserInfo().then((ev) => {
            //Fetched User details 
            // Now access of userInfo variable access 
            showPermissions();
    ...
    function setupPage() {
        // fetch verticals of the permissions
        let data = {
            url: KBASE_URL + 'user/role/get',
            param: '',
        };
        $('#current-permissions-role').on('change', function(data) {
            addPermissionsLayout();
        });

        // Add Item Removed Event 
        $('#current-permissions-role').on('select2:unselecting', function(data) {
            let item = data.params.args.data.id;
            item = item.replaceAll(' ', '-');
            $(`#${item}-permissions-body`).parent().parent().parent().remove();
        });
        ...
        postRequest(data, false, function(mData, mStatus) {
            if (mData.status === 'success') {
                let dbRoles = mData.data.roles;
                verticals = mData.data.verticals;
                dbRoles.map((value, index) => {
                    rolesList.append(new Option(value.toWord(), value, true, false));
                });
    ...
    function showPermissions() {
        ...
        let usersRoles = userInfo.userPermissionsInfo;

        // Loop Through users Roles
        let rolesArr = [];
        for (const [key, value] of Object.entries(usersRoles)) {
            rolesArr.push(key);
        }
        select.val(rolesArr);
        select.trigger('change'); //Trigger onchange for show changes

        let permissions = getPermissions(select.val());
        // Set Roles Assigned to this User
    }
    ...
    $('#permission-form').on('submit', function() {
        event.preventDefault();
        let selectedRoles = $('#current-permissions-role').val();
        let postData = new Object();
        selectedRoles.map((value, index) => {
            let formValue = value;
            value = value.replaceAll(" ", "-");
            let currentForm = $(`#${value}-permissions-form`);

            let data = new Object();
            $.each($(currentForm).serializeArray(), function(_, field) {
            ...
            postData[formValue] = data;
            logger(value);
            logger(data);
        });

        let requestData = {
            url: KBASE_URL + `partner/<?php echo $username; ?>/edit/permissions`,
    ...
    // when #current-permissions-role changes
    function addPermissionsLayout() {
        let selectedRoles = $('#current-permissions-role').val();
        selectedRoles.map((value, index) => {
            value = value.replaceAll(" ", "-"); // replace all the spaces by Pipe, it create problem when adding id 
            if ($(`#${value}-permissions-body`).attr('id') === undefined) {
                getPermission(value);
            }
        });
    }
    ...
    // if there is already sent by the server
    function getPermission(selectRole) {
        getPermissionsTableHtml(selectRole);
        // Check if this type of
        let tbody = $(`#${selectRole}-permissions-body`);
        let html = '';
        ...
        if (verticals) {
            for (let i = 0; i < verticals.length; i++) {
                ...
                html += `<td><input type="checkbox" name="${key}_create" ${checkPermission(selectRole, 'create', key) ? 'checked' : ''}/></td>`;
                html += `<td><input type="checkbox" name="${key}_view" ${checkPermission(selectRole, 'view', key) ? 'checked' : ''}/></td>`;
                html += `<td><input type="checkbox" name="${key}_edit" ${checkPermission(selectRole, 'edit', key) ? 'checked' : ''}/></td>`;
                html += `</tr>`;
            }
        }
    ...
    // return true if user has permissions for this action
    function checkPermission(target, action, vertical) {
        // Remove hyphen (-) 
        target = target.replaceAll("-", " ");
        let permissions = userInfo.userPermissionsInfo;

        // console.log(permissions);
        if (permissions[target] !== undefined) { //user has some permissions for this vertical
            let perm = permissions[target][vertical];
            if (perm !== undefined) {
                if (perm === 'all') {
                    return true;
                } else {
    ...
    // This function
    function getPermissionsTableHtml(heading) {
        let html = `<div><h4>${heading.toWord()} Permissions</h4>
        <hr>
        <form id="${heading}-permissions-form">
        <table class="table table-bordered">
        <thead>
            <tr>
                <th>Target</th>
            ...
            <tbody id="${heading}-permissions-body">
            </tbody>
            
         </table>
         </form>
         </div>`;
        $('#user-permissions').append(html);
    }
