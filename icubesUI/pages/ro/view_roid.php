                            ...
                            <div class="card card-custom">
                                ...
                                <div class="card-header">
                                    <div class="card-title">
                                        <h3 class="card-label">
                                            Release Order
                                            <small><?php echo ucwords($roid) ?></small>
                                        </h3>
                                    </div>
                                </div>
                                <!--end::Card header-->
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control id" name="roName" id="roName" placeholder="RO Name">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-12 col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="mt-4">
                                                    <a target="_blank" id="roDoc" href="${KBASE_URL}${data.roDoc}">&nbsp;</a>
                                                    </div>
                                                </div>
                                            </div>
...
<script>
    // Setup Permissions
    function __init() {
        let url = KBASE_URL + `roid/<?php echo $roid ?>/view`;
        let form = $('#roid-form');
